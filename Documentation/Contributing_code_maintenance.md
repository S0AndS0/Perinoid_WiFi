...
> and are operating within the `Parinoid_WiFi/` directory.
...
```
vim Documentation/ReadMe_Paranoid_WiFi.md
# Or nano
nano Paranoid_WiFi.sh
```
...
Var_git_url='git@github.com:S0AndS0/Paranoid_WiFi.git'
